<template>
  ...
  const { addDiscount, fetchOneDiscount } = useDiscountStore();
  ...
  onMounted(async () => {
   ...
   const response = await fetchOneDiscount($route.params.id);
    NewDiscount.value.ProductId = response.data.ProductId;
    NewDiscount.value.level = response.data.level;
    NewDiscount.value.discountPercentage = response.data.discountPercentage;
